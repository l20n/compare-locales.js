...
GaiaApp.prototype.getLangpacks = function(locales) {
  ...
  var createLangpacks = function(manifest) {
  ...
  return this._langpacks ||
    (this._langpacks = this.getManifest().then(createLangpacks));
};
...
GaiaApp.prototype.getLangpackFromPath = function(l10nRootPath, localeCode) {
  ...
  this.getResources().forEach(function(resID) {
