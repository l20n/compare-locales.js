...
WebApp.resourceFormats = {
  'l20n': 'l20n',
  'properties': 'gaia_properties'
};

WebApp.enableChecks = function() {
};

WebApp.disableChecks = function() {
};
...
WebApp.prototype.getResources = function() {
...
WebApp.prototype.getLangpack = function(pathBuilder, loc, path) {
...
WebApp.prototype.getLangpackFromSource = function(loc) {
...
WebApp.prototype.getLangpackFromPath = function(l10nRootPath, loc) {
...
function buildResourcePath(appPath, sharedPath, relResPath) {
  ...
  if (isSubjectToBranding(absResPath)) {
