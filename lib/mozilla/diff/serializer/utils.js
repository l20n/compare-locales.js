...
exports.sortEntries = function(a, b) {
  if (a[2] < b[2]) {
    return -1;
  }
  if (a[2] > b[2]) {
...
function collapseCommon(struct, depth) {
  var key;
  ...
  for (key in struct) {
    ...
    if (sub !== null &&
      ...
      var ret = collapseCommon(struct[key], depth + 1);
      if (ret[0]) {
  ...
  if (depth > 0 && Object.keys(struct).length === 1) {
...
exports.createStructuredDiff = function(entries) {
  ...
  return collapseCommon(struct, 0)[1];
}
